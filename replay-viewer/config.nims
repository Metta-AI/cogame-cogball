...
# use-after-free fixed in cogball_replay.nim (emscripten_exit_with_live_runtime)
...
# cogball_error_len(). Aborting keeps linear memory intact, and the page reads
# cogball_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "cogball_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cogball_load_replay,_cogball_frame,_cogball_input,_cogball_packet_ptr,_cogball_packet_len,_cogball_mismatch_tick,_cogball_error_ptr,_cogball_error_len,_cogball_stage_ptr,_cogball_stage_len
  """).replace("\n", " ")
)
