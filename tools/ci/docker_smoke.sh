...
# Substitute: cogball, coworld-cogball, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-cogball:ci)
#   SMOKE_SLUG                 game slug                        (cogball)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/cogball)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/cogball-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-cogball:ci}}"
slug="${SMOKE_SLUG:-cogball}"
