...
//
// SOAK -- LOADING IS NOT PLAYING (cogball delta, 2026-08-23)
// ---------------------------------------------------------
// This copy adds `--soak <seconds>`, which is NOT yet in coworld-builder's
// template: after the load signal it watches the clock / tick / scorebug for
